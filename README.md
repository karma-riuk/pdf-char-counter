...
```bash
sudo wget -O /usr/local/bin/pdf_char_counter https://raw.githubusercontent.com/karma-riuk/pdf-char-counter/master/pdf_char_counter && sudo chmod 755 /usr/local/bin/pdf_char_counter && echo "Install successful" || echo "Something went wrong"
```
